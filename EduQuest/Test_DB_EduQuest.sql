...
VALUES
    ...
    ('Test', 'Docente', 'a', 'aaa@prova.edu', 'a', 'Docente');
...
VALUES
    ('Matematica', 'Prova di matematica', 5, '2001-09-11', 3),
    ('Italiano', 'Prova di italiano', 3, '2004-06-05', 3),
    ('Simbolismo', 'La nebbia agli irti colli piovigginando sale', 1, '2026-01-24', 3);

INSERT INTO domande (tipo, testo, numeroRisposte, rispostaCorrettaID, questionarioID_FK)
VALUES
    ('1', 'Domanda Generica 1', '3', NULL, '1'),
    ('1', 'Domanda Generica 2', '2', NULL, '1');

INSERT INTO RISPOSTE (testo, domandaID_FK)
VALUES
    ('Risposta Generica A', '1'),
    ('Risposta Generica B', '1'),
    ('Risposta Generica C', '1'),
    ('Risposta Generica D', '2'),
    ('Risposta Generica E','2');

UPDATE domande SET rispostaCorrettaID = 2  WHERE domandaID = 1;
UPDATE domande SET rispostaCorrettaID = 5  WHERE domandaID = 2;